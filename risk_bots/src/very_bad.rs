...
impl ManagedPlayer for VeryBad {
    ...
    fn query_attack(&mut self, state: &ClientState) -> Option<MoveAttack> {
        ...
        enemy_territories
            .sort_by(|&t1, &t2| territory_strength(t1).total_cmp(&territory_strength(t2)));
